      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-2 md:grid-cols-4 gap-8 text-xs border-b border-slate-900">
        ...
        <div className="space-y-3.5">
          ...
          <ul className="space-y-2 text-slate-400">
            <li><Link href="/chinh-sach" className="hover:text-accent-500 transition-colors flex items-center gap-1">Chính sách giao hàng <ArrowUpRight size={10} /></Link></li>
            <li><Link href="/chinh-sach" className="hover:text-accent-500 transition-colors flex items-center gap-1">Chính sách bảo hành <ArrowUpRight size={10} /></Link></li>
            <li><Link href="/chinh-sach" className="hover:text-accent-500 transition-colors flex items-center gap-1">Chính sách đổi trả <ArrowUpRight size={10} /></Link></li>
            <li><Link href="/chinh-sach" className="hover:text-accent-500 transition-colors flex items-center gap-1">Điều khoản thanh toán <ArrowUpRight size={10} /></Link></li>
          </ul>
        </div>
        ...
        <div className="space-y-3.5">
          ...
          <ul className="space-y-2 text-slate-400">
            <li><Link href="/products?sub=may-mai-san" className="hover:text-secondary-500 transition-colors">Máy mài sàn bê tông</Link></li>
            <li><Link href="/products?sub=may-cha-san" className="hover:text-secondary-500 transition-colors">Máy vệ sinh công nghiệp</Link></li>
            <li><Link href="/products?sub=son-epoxy" className="hover:text-secondary-500 transition-colors">Sơn phủ sàn Epoxy</Link></li>
            <li><Link href="/products?sub=dia-mai-be-tong" className="hover:text-secondary-500 transition-colors">Đĩa mài mâm xoa</Link></li>
          </ul>
        </div>
