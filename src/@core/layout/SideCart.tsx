...
import { X, Trash2, FileText, Send, CheckCircle2, Truck, Plus, PackagePlus, AlertTriangle, FileSpreadsheet, Percent, HelpCircle } from 'lucide-react'
...
export default function SideCart() {
  ...
  // Trigger shipping calculation on address input blur
  useEffect(() => {
                  ...
                  <div className="space-y-2.5">
                    ...
                    {paymentMethod === 'TRANSFER' && (
                      <div className="bg-slate-50 border border-slate-200 rounded-xl p-3 text-[11px] text-slate-600 space-y-1 font-semibold leading-relaxed">
                        <p className="text-slate-800 font-extrabold uppercase text-[10px] text-primary-900">Thông tin tài khoản Khang Phúc:</p>
                    ...
                    {paymentMethod === 'QRCODE' && (
                      <div className="bg-slate-50 border border-slate-200 rounded-xl p-3 text-center space-y-2">
                        <span className="text-slate-800 font-extrabold uppercase text-[10px] text-primary-900 block text-left">Quét mã VietQR thanh toán nhanh:</span>
