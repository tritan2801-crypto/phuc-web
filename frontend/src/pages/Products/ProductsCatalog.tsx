...
import { Filter, Grid, List, ArrowUpDown, ShieldAlert, Award } from 'lucide-react'
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
              {filteredProducts.map(prod => {
                ...
                return (
                  ...
                  >
                    <Link to={`/products/${prod.id}`} className="block relative h-44 bg-slate-50 overflow-hidden">
            ...
            <div className="space-y-4">
              {filteredProducts.map(prod => {
                ...
                return (
                  ...
                  >
                    <Link to={`/products/${prod.id}`} className="w-full sm:w-44 h-32 relative rounded-xl overflow-hidden bg-slate-50 flex-shrink-0">
                      <PexelsImage query={prod.image} className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
                    </Link>
