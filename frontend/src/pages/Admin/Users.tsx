        ...
        <form onSubmit={handleCreateUserSubmit} className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <select
              ...
              onChange={(e) => setFormFields({ ...formFields, role: e.target.value as 'USER' | 'ADMIN' })}
          ...
          <button
            ...
            className="w-full py-3 bg-teal-500 hover:bg-teal-400 disabled:bg-teal-800 text-slate-950 font-bold text-xs rounded-xl flex items-center justify-center gap-1.5 cursor-pointer transition-all shadow-md shadow-teal-500/10"
          >
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl lg:col-span-2 overflow-hidden shadow-xl h-fit">
        ...
        {loading ? (
          ...
          <div className="py-16 text-center text-slate-500 space-y-2">
            <UsersIcon className="mx-auto text-slate-700" size={48} />
                  ...
                  <tr key={item.id} className="hover:bg-slate-800/20 transition-colors">
                    ...
                    <td className="p-4">
                      {item.role === 'ADMIN' ? (
                        ...
                        <span className="px-2 py-0.5 rounded bg-slate-950 border border-slate-800 text-[9px] font-bold text-slate-500 uppercase tracking-wider">
                          Đại lý sỉ (USER)
                        </span>
                      )}
                    </td>
